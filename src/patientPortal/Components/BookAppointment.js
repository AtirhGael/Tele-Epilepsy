      ...
      <View style={styles.button1}>
       ...
       <TouchableOpacity style={[styles.bellow, checked === 1 ? { backgroundColor: '#7851a9' } : null]} onPress={() => setChecked(1)}>
        ...
        <TouchableOpacity style={[styles.bellow, checked === 2 ? { backgroundColor: '#7851a9' } : null]} onPress={() => setChecked(2)}>
            ...
            <View style={{display:'flex',flexDirection:'column', gap:3}}>
                <Text style={[ checked === 2 ? { color: "white",fontSize:15,fontWeight:'500' } : null]}> Vedio Call </Text>
                <Text style={[styles.btnText, checked === 2 ? { color: "white",fontSize:15,fontWeight:'500' } : null]}> Can mak a vedio call with doctore </Text>
            </View>
